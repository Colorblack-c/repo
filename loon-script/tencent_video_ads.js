...
const promotionServicePattern = /(?:trpc\.promotion\.adapter\.adapter\/GetFloatActivityJ?|trpc\.flow_pool\.gateway\.FlowPoolActivity\/GetPromotionGlobalConfigJ?|trpc\.vip_ad_promotion\.access_adaptor\.(?:CommonAccessService\/AccessPromotionJ?|Adaptor)|trpc\.iwan\.chosen_page_service\.ChosenPageService\/GetRecentGameSlipJ?|trpc\.iwan\.sdk_report\.Report\/GetGameInfoV2J?|trpc\.iwan\.valueattribution\.ValueAttribution\/AttributionReportJ?|trpc\.growth_raptor\.access\.AccessApi\/activity\/access\/PopupContentWithTaskJ?|trpc\.iwan\.usr_portrait\.UsrPortrait\/OnlineInsightsWarmUpJ?|trpc\.reward_ad_ssp\.[^/]+\/[A-Za-z0-9_]*Reward[A-Za-z0-9_]*J?|trpc\.reward_ad_ssp\.reward_judgment\.pendant\/GetRewardPendantJ?|trpc\.business_feeds\.video_ad_ssp_feeds\.ServerAdFeedsVideo\/GetPersonalCenterAdDataJ?|trpc\.adapter_group\.mobile_sdk_adapter\.CMCCPromoPushService\/GetSDKInitDataJ?|trpc\.activity\.memberExperience\.ActivityTcp\/getHomeGrowPopupUrlJ?|trpc\.video_channel_hunter\.video_attribution_svr\.GenerateCaidService|trpc\.video_growth_config\.gateway\.ResourcePreloadService\/GetPreloadResourceListJ?|trpc\.user_data\.personal_recommend_setting\.PersonalRecommendSettingTrpc\/GetRecommendSettingJ?)/i;
